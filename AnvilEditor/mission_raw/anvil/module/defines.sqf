...
#define AFW_NONE                    -1
#define AFW_MISSIONTYPES            ["Capture", "Gather intel in", "Assassinate officer in", "Destroy tower in", "Destroy AA in", "Clear enemy from ", "Destroy ammo cache in ", "Destroy crashed UAV in ", "Gather Crash Site Intel in ", "Destroy Crashed Helo in "]
