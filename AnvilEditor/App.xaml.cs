namespace AnvilEditor
{
    ...
    public partial class App : Application
    {
        ...
        /// <summary>
        /// Logs the exception through Raven/Sentry. Wraps in generic try-catch to prevent an endless exception loop
        /// </summary>
        /// <param name="e"></param>
        private void CaptureException(Exception e)
        {
            ...
            {
                Log.Error("EXCEPTION OCURRED WHILST TRY TO REPORT AN EXCEPTION! OH DEAR!");
